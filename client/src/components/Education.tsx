  ...
  return (
    ...
    >
      <div className="max-w-6xl w-full flex items-start gap-12 md:gap-20 lg:gap-32">
        ...
        >
          <h2
            className="text-2xl md:text-3xl font-semibold tracking-wider text-foreground/70 uppercase"
            style={{ writingMode: "horizontal-tb", marginRight: "2rem" }}
            data-testid="text-education-main-title"
          >
            MY EDUCATION
          </h2>
        </motion.div>
            ...
            >
              ...
              <div className="pl-6 md:pl-8">
                ...
                <motion.div
                  ...
                  className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4 mb-3"
                >
                  <h3
                    className="text-lg md:text-xl font-bold font-grotesk"
                ...
                <motion.h4
                  ...
                  className="text-base md:text-lg text-primary font-semibold mb-3 font-grotesk"
                ...
                <motion.p
                  ...
                  className="text-sm md:text-base text-foreground/70 mb-4 font-light leading-relaxed"
