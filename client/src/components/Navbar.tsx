...
// ─── NavAnimated — versione senza ScrollTrigger, parte al mount ───────────────
  ...
  useEffect(() => {
    const layout = () => {
      circleRefs.current.forEach((circle) => {
        ...
        if (w === 0 || h === 0) return; // ancora nascosto, salta
    ...
    // aspetta che tutte le NavAnimated abbiano finito (l'ultima finisce a 0.2 + 4*0.08 + 0.55 ≈ 1.1s)
